  ...
  <div>
    ...
    <el-card class="t-box-card">
      ...
      <el-table class="t-table-list" ref="table" border stripe size="small" tooltip-effect="dark"
        ...
        <el-table-column prop="name1" label="教室类型" :show-overflow-tooltip="true" align="center"></el-table-column>
        <el-table-column prop="name2" label="寝室人数" :show-overflow-tooltip="true" align="center"></el-table-column>
        <el-table-column prop="name3" label="备注" :show-overflow-tooltip="true" align="center"></el-table-column>
...
<script>
import addEdit from "./dormitory-type-add-edit";
...
export default {
  data () {
    return {
      ...
      total: 0,
      tableData: [
          {id: 1,name1: '8人寝室',name2: '8',name3: '备注'},
          {id: 2,name1: '学校减免',name2: '6',name3: '备注'},
      ],
      isSelectAll: false,
      multipleSelection: [],
      addEditForm: {},
