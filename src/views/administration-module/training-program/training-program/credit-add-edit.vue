<template>
  <el-dialog class="t-dialog" :title="form.id?'编辑学分要求':'新增学分要求'" v-if="visible" :visible="visible" :close-on-click-modal="false" width="40%" @close="close">
    <el-form class="t-form-block" ref="form" :model="form" :rules="rules" label-width="80px" size="small">
      ...
      <el-form-item label="要求学分" prop="name2">
