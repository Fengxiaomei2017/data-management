  ...
  <div>
    ...
    <el-card class="t-box-card">
      ...
      <el-table class="t-table-list" ref="table" border stripe size="small" tooltip-effect="dark"
        ...
        <el-table-column prop="name1" label="层次代码" :show-overflow-tooltip="true" align="center"></el-table-column>
        <el-table-column prop="name2" label="办学层次" :show-overflow-tooltip="true" align="center"></el-table-column>
        <el-table-column prop="name3" label="描述" :show-overflow-tooltip="true" align="center"></el-table-column>
...
<script>
import addEdit from "./school-running-add-edit";
...
export default {
  data () {
    return {
      ...
      total: 0,
      tableData: [
          {id: 1,name1: '01001',name2: '中职',name3: '中专学生学习内容'},
          {id: 2,name1: '01002',name2: '高职',name3: '中专学生学习内容'},
      ],
      isSelectAll: false,
      multipleSelection: [],
      addEditForm: {},
